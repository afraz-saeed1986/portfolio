import {Button, Typography, Slide, Card, CardContent, CardMedia, CardActionArea, CardActions } from "@mui/material";
                                ...
                                <Grid key={index} xs={12} sm={6} md={6} lg={4} xl={4} sx={{px:2, mb:2}} > 
                                    <Slide direction="up" in={loading} style={{
                                        ...
                                        <Card sx={{maxWidth:345, backgroundColor: "steelblue"}}>
                                            ...
                                            <CardActions>
                                                <Button href={course.link} size="small" color="primary" target="_blanck">
                                                    اطلاعات بیشتر
                                                </Button>
                                            </CardActions>
                                        </Card>
